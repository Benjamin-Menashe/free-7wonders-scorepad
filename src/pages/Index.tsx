...
const wonderInfo: Record<WonderBoardType, { name: string; description: string }> = {
  ...
  ephesus: { name: 'Éphesos', description: 'The Temple of Artemis' },
  giza: { name: 'Gizah', description: 'The Great Pyramid' },
  halicarnassus: { name: 'Halikarnassos', description: 'The Mausoleum' },
  olympia: { name: 'Olympía', description: 'The Statue of Zeus' },
  rhodes: { name: 'Rhódos', description: 'The Colossus' },
...
const Index = () => {
  ...
  // Get available boards for each player
  const getAvailableBoards = (currentPlayerId: string) => {
    if (activeTab === 'solo') {
      return wonderBoards;
    }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
          ...
          <TabsContent value="all-players" className="mt-6">
            ...
            {/* Wonder Boards Grid with Conditional Drag and Drop */}
            {allExpanded ? (
